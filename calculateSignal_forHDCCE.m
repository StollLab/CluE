% TO DO: Either remove HD-CCE functionality and "rm *_forHDCCE.m",
% or merge calculateSignal_forHDCCE() into calculateSignal() 
% and then "rm *_forHDCCE.m".
...
[Coherences_1, SubclusterIndices_2, Coherences_2, ...
  ...
  Nuclei.rotationalMatrix,nPoints^dimensionality,methylMethod1,...
...
for clusterSize = 1:Method_order
  ...
  for iCluster = numClusters:-1:1
    ...
    if any(isMethylHydron(Cluster) )
      error(['Error in calculateSignal_forHDCCE(): ',...
    ...
    if useInterlacedClusters(Method_order,clusterSize)
      ...
      [tensors,zeroIndex] = pairwisetensors(Nuclei_g, Nuclei_Coordinates,...
    ...
    % Loop over cyclic permutations.
      for iPerm = 1:nPerm
        ...
        [tensors,zeroIndex] = pairwisetensors(Nuclei_g, ...
        ...
        if doTR        
          [tensors_TR,~] = pairwisetensors(Nuclei_g, ...
          Nuclei_Coordinates,thisCluster,Atensors,magneticField, ge,geff,...
        ...
        % Build Hamiltonians.
        [H_alpha,H_beta] = ...
          assembleHamiltonian(state_multiplicity(thisCluster),...
      ...
      switch clusterSize
        case 1
          Coherences_1(iCluster,:) = Coherences_1(iCluster,:)  +  ...
            propagate(total_time,nPoints,dt,dt2,N1,Hb,Ha,Hb_TR,Ha_TR, ...
...
[Signals, AuxiliarySignal_1,AuxiliarySignal_2,...
  ...
  = doOffsetClusterCorrelationExpansion_forHDCCE(Coherences_1,Coherences_2,...
...
[Signals, AuxiliarySignal_1,AuxiliarySignal_2,...
  AuxiliarySignal_3,AuxiliarySignal_4] ...
  = doClusterCorrelationExpansion_forHDCCE(Coherences_1,Coherences_2,...
  Coherences_3,Coherences_4,Coherences_5,Coherences_6,ClusterArray, ...
  SubclusterIndices_2,SubclusterIndices_3,SubclusterIndices_4,...
  SubclusterIndices_5,SubclusterIndices_6,...
  nPoints,dimensionality, Method_order,numberClusters, Nuclei_Abundance);
...
switch clusterSize
  ...
  case 2
    SubclusterIndices_2(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 3
    SubclusterIndices_3(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 4
    SubclusterIndices_4(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 5
    SubclusterIndices_5(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 6
    SubclusterIndices_6(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 7
    SubclusterIndices_7(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 8
    SubclusterIndices_8(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 9
    SubclusterIndices_9(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 10
    SubclusterIndices_10(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 11
    SubclusterIndices_11(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  case 12
    SubclusterIndices_12(:,:,iCluster) = findSubclusters_forHDCCE(...
      ClusterArray,clusterSize,iCluster,clusterSize);
  otherwise
